...
Configuration for Optical Character Recognition (OCR) text extraction from uploaded images and documents.
...
Settings for OCR image and document text extraction.
