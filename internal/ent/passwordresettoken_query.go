...
func (_q *PasswordResetTokenQuery) QueryAccount() *AccountQuery {
...
func (_q *PasswordResetTokenQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *PasswordResetTokenQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *PasswordResetTokenQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *PasswordResetTokenQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *PasswordResetTokenQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (_q *PasswordResetTokenQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PasswordResetTokenQuery) WithAccount(opts ...func(*AccountQuery)) *PasswordResetTokenQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *PasswordResetTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PasswordResetToken, error) {
	...
	if query := _q.withAccount; query != nil {
		if err := _q.loadAccount(ctx, query, nodes, nil,
			func(n *PasswordResetToken, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PasswordResetTokenQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*PasswordResetToken, init func(*PasswordResetToken), assign func(*PasswordResetToken, *Account)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*PasswordResetToken)
	for i := range nodes {
...
func (_q *PasswordResetTokenQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAccount != nil {
			_spec.Node.AddColumnOnce(passwordresettoken.FieldAccountID)
		}
	}
